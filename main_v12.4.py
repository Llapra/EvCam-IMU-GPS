        ...
        while self.running:
            try:
                ...
                for evs in mv_iterator:
                    ...
                    # 2. LÓGICA DE VISUALIZACIÓN OPTIMIZADA (Drop-Frame)
                    now = time.time()
                    ...
                    if (now - last_visual_time) >= visual_period:
                        ...
                        visual_buffer.fill(0) # Limpiar el buffer del frame anterior
                        ...
                        # Emitir estadísticas solo cuando se actualiza la interfaz
                        debug_text = ""
                        ...
                        # Saltar procesamiento de arrays de NumPy: Mantiene la cola de eventos vacía y la RAM libre
                        pass

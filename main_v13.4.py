...
class CameraWorker(QThread):
    ...
    def start_recording(self, staging_dir, final_dest_dir, prefix):
...
class MainWindow(QMainWindow):
    ...
    def _start_camera(self, cam_id):
        ...
        # Inyectamos la duración seleccionada en el ComboBox al hilo de la cámara
        worker.chunk_duration_s = self.cmb_chunk.currentData()
    ...
    def toggle_recording(self):
        ...
        if not is_recording:
            ...
            # CORRECCIÓN DE RUTAS: Pasamos el SSD temporal y el HDD final
            if self.worker_1: self.worker_1.start_recording(self.staging_dir, final_cam_dir, "EvCam1")
            if self.worker_2: self.worker_2.start_recording(self.staging_dir, final_cam_dir, "EvCam2")
        else:

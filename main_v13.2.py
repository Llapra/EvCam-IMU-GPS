                            ...
                            # --- PARSER DE COORDENADAS Y SELLO RAÍZ (ATM) ---
                                ...
                                try:
                                    ...
                                    if self.armed and valid == 1:
                                        ...
                                        self.armed = False
                                        self._open_new_chunk() # Abre el archivo en el SSD antes de escribir
                                        ...
                                        self.log_signal.emit(f"🎯 [ATM FIJADO] Época: {hour:02d}:{minute:02d}:{second:02d} UTC. ¡Grabando (Chunk)!")

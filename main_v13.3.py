        ...
        while self.running:
            try:
                ...
                for evs in mv_iterator:
                    ...
                    # --- 1. LÓGICA DE CHUNKING Y STAGING ---
                    ...
                    if self.req_stop_rec:
                        if i_events_stream and self.recording:
                            i_events_stream.stop_log_raw_data()
                            # Enviar el último archivo a la cola
...
class MainWindow(QMainWindow):
    ...
    def create_controls_panel(self):
        ...
        self.cmb_chunk.addItem("1.5 Horas", 5400)
        self.cmb_chunk.addItem("2 Horas", 7200)
        self.cmb_chunk.setCurrentIndex(2) # Selecciona "1 Hora" por defecto
